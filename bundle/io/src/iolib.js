var io = {
	...
	init : function(cfg, callback) { 
		this.cfg = cfg;
		//if(io.cfg.userid in io.uniquesids){
		//if(io.uniquesids.hasOwnProperty("io.cfg.userid")){
		//if(io.uniquesids !=null && io.uniquesids[io.cfg.userid] != undefined){
	...
	wsconnect : function(){
		...
		this.sock.onclose = function(e) {//alert('socket closed');
